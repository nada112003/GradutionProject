...
using System.Text.Json;  // Ensure using correct namespaces for JSON parsing
...
namespace GradutionP.Services
{
    public class PatientService : IPatientService
    {
        ...
        // ✅ 1️⃣ Get all doctors appointments/availabilities with their status (reserved or available)
        ...
        // ✅ 2️⃣ Book a specific appointment from the available appointments
